export default function Training() {
    ...
    return (
        <>
            <div className="bg-white p-4 rounded-lg overflow-y-scroll md:max-h-well order-first md:order-last md:max-w-lg mx-auto">
                <h2 className="text-2xl text-gray-700 font-bold mb-2">Search Training Records</h2>
                <p className="mb-6 text-sm">Search for your trianing records below by providing your Rural Water Passport email address, or your training license number.</p>
