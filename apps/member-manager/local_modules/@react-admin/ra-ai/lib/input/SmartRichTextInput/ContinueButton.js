...
var EditNote_1 = __importDefault(require("@mui/icons-material/EditNote"));
var SmartRichTextInputParamsContext_1 = require("./SmartRichTextInputParamsContext");
var ContinueButton = function (props) {
    ...
    var _a = (0, SmartRichTextInputParamsContext_1.useSmartRichTextInputParamsContext)(props), locale = _a.locale, mutationOptions = _a.mutationOptions, params = __rest(_a, ["locale", "mutationOptions"]);
    var _b = (0, react_query_1.useMutation)(function (prompt) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return (React.createElement(material_1.ToggleButton, __assign({ "aria-label": label, title: label, value: label, onClick: replace, disabled: !(editor === null || editor === void 0 ? void 0 : editor.isEditable) || isLoading, selected: isLoading }, sanitizeRestProps(props)),
        React.createElement(EditNote_1.default, { fontSize: "inherit" })));
};
