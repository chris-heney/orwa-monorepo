...
exports.PredictiveTextInput = void 0;
var React = __importStar(require("react"));
var react_admin_1 = require("react-admin");
var clsx_1 = __importDefault(require("clsx"));
var TextFieldWithCompletion_1 = require("./TextFieldWithCompletion");
var usePredictiveTextInputController_1 = require("./usePredictiveTextInputController");
/**
 ...
 * );
 */
var PredictiveTextInput = function (props) {
    ...
    var _a = (0, react_admin_1.useInput)(__assign({ defaultValue: defaultValue, format: format, parse: parse, resource: resource, source: source, type: 'text', validate: validate, onBlur: onBlur, onChange: onChange }, rest)), field = _a.field, _b = _a.fieldState, error = _b.error, invalid = _b.invalid, isTouched = _b.isTouched, isSubmitted = _a.formState.isSubmitted, id = _a.id, isRequired = _a.isRequired;
    var _c = (0, usePredictiveTextInputController_1.usePredictiveTextInputController)({
        field: field,
        locale: locale,
    ...
    return (React.createElement(TextFieldWithCompletion_1.TextFieldWithCompletion, __assign({ id: id }, field, { className: (0, clsx_1.default)('ra-input', "ra-input-".concat(source), className), label: label !== '' && label !== false ? (React.createElement(react_admin_1.FieldTitle, { label: label, source: source, resource: resource, isRequired: isRequired })) : null, error: (isTouched || isSubmitted) && invalid, helperText: React.createElement(react_admin_1.InputHelperText, { touched: isTouched || isSubmitted, error: error === null || error === void 0 ? void 0 : error.message, helperText: helperText }) }, (0, react_admin_1.sanitizeInputRestProps)(rest), { completion: completion, onFocus: handleFocus, onBlur: handleBlur, onKeyDown: handleKeyDown })));
};
exports.PredictiveTextInput = PredictiveTextInput;
