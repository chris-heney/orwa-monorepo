 ...
 */
export var addGetCompletionBasedOnOpenAIAPI = function (_a) {
    var dataProvider = _a.dataProvider, _b = _a.endpoint, endpoint = _b === void 0 ? 'https://api.openai.com/v1/completions' : _b, _c = _a.defaultParams, defaultParams = _c === void 0 ? DEFAULT_PARAMS : _c, _d = _a.httpClient, httpClient = _d === void 0 ? fetchUtils.fetchJson : _d;
