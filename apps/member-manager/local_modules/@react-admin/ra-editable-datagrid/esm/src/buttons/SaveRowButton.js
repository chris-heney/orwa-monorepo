...
import { useSaveContext, useTranslate, setSubmissionErrors, } from 'react-admin';
...
export var SaveRowButton = function (_a) {
    ...
    var onClick = useCallback(function (event) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    return (React.createElement(Tooltip, { title: label },
        React.createElement(IconButton, { "aria-label": label, disabled: saving || saveContext.saving, onClick: onClick, size: "small", color: "primary", form: "row".concat(id), type: type },
