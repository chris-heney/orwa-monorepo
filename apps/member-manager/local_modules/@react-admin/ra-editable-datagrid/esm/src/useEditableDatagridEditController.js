...
import { useMutationMiddlewares, useNotify, useRecordContext, useResourceContext, useUpdate, } from 'react-admin';
 ...
 * };
 */
export var useEditableDatagridEditController = function (props) {
    ...
    var _b = useMutationMiddlewares(), registerMutationMiddleware = _b.registerMutationMiddleware, getMutateWithMiddlewares = _b.getMutateWithMiddlewares, unregisterMutationMiddleware = _b.unregisterMutationMiddleware;
    var updateParams = { id: record.id, previousData: record };
    var _c = useUpdate(resource, undefined, __assign(__assign({}, otherMutationOptions), { mutationMode: mutationMode, returnPromise: mutationMode === 'pessimistic' })), update = _c[0], saving = _c[1].isLoading;
