...
import { Configurable, useResourceContext, usePreference, useStore, useTranslate, } from 'react-admin';
 ...
 * );
 */
export var EditableDatagridConfigurable = function (_a) {
    ...
    return (React.createElement(Configurable, { editor: React.createElement(EditableDatagridEditor, null), preferenceKey: finalPreferenceKey, sx: { display: 'block', minHeight: 2 } },
...
var EditableDatagridWithPreferences = function (_a) {
    ...
    return (React.createElement(EditableDatagrid, __assign({}, props), columns === undefined
        ? children
