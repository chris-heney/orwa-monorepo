...
exports.RowFormConfigurable = void 0;
 ...
 */
var RowFormConfigurable = function (props) {
    ...
    return (React.createElement(RowForm_1.default, __assign({}, rest), columns === undefined
        ? children
        : columns.map(function (index) { return childrenArray[index]; })));
};
exports.RowFormConfigurable = RowFormConfigurable;
