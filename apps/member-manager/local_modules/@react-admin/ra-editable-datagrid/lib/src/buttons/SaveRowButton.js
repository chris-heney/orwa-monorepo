...
var SaveRowButton = function (_a) {
    var handleSubmit = _a.handleSubmit, saving = _a.saving, _b = _a.submitOnEnter, submitOnEnter = _b === void 0 ? true : _b, mutationOptions = _a.mutationOptions, transform = _a.transform;
    ...
    var hasSideEffects = (mutationOptions &&
        ...
        transform;
    var type = !submitOnEnter || hasSideEffects ? 'button' : 'submit';
    var _c = form.getValues().id, id = _c === void 0 ? 'new_record' : _c;
    ...
    var onClick = (0, react_1.useCallback)(function (event) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    return (react_1.default.createElement(material_1.Tooltip, { title: label },
        react_1.default.createElement(material_1.IconButton, { "aria-label": label, disabled: saving || saveContext.saving, onClick: onClick, size: "small", color: "primary", form: "row".concat(id), type: type },
            react_1.default.createElement(Save_1.default, null))));
};
exports.SaveRowButton = SaveRowButton;
