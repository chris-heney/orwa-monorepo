...
var RowForm = function (props) {
    ...
    var _b = (0, react_admin_1.useAugmentedForm)(__assign({ defaultValues: __assign(__assign({}, defaultValues), record), record: record, onSubmit: save, mode: 'onSubmit' }, rest)), form = _b.form, formHandleSubmit = _b.formHandleSubmit;
    var hasSideEffects = (mutationOptions &&
        ...
        transform;
    var handleSubmitWithSideEffects = (0, react_1.useCallback)(function (values) { return __awaiter(void 0, void 0, void 0, function () {
        var errors;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    if (errors != null) {
                        (0, react_admin_1.setSubmissionErrors)(errors, form.setError);
                    }
                    return [2 /*return*/];
            }
        });
    ...
    var handleKeyDown = (0, react_1.useCallback)(function (event) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    return (React.createElement(react_admin_1.OptionalRecordContextProvider, { value: record },
        React.createElement(react_hook_form_1.FormProvider, __assign({}, form),
            react_1.Children.map(children, function (field, index) {
                return (0, react_1.isValidElement)(field) ? (React.createElement(material_1.TableCell, { key: index, className: field.props.cellClassName, align: field.props.textAlign, onKeyDown: handleKeyDown }, field)) : null;
            }),
...
var RowFormActionsTableCell = function (_a) {
    ...
    return (React.createElement(StyledTableCell, { className: "RaRowForm-actionColumn" },
        React.createElement(buttons_1.SaveRowButton, { handleSubmit: handleSubmit, mutationOptions: mutationOptions, transform: transform }),
        React.createElement(buttons_1.CancelEditButton, null)));
};
var StyledTableCell = (0, material_1.styled)(material_1.TableCell, {
    name: PREFIX,
