...
exports.DatagridRowClasses = void 0;
...
var EditableDatagridRowEditBase_1 = require("./EditableDatagridRowEditBase");
var EditableRow = function (props) {
    ...
    var context = (0, react_admin_1.useDatagridContext)();
    ...
    var expandable = (!context ||
        ...
        expand;
    var _c = (0, react_admin_1.useExpanded)(resource, id, context && context.expandSingle), expanded = _c[0], toggleExpanded = _c[1];
    var _d = (0, react_1.useState)(false), isEdit = _d[0], setEdit = _d[1];
    var openEditMode = (0, react_1.useCallback)(function () {
        setEdit(true);
    }, []);
    var closeEditMode = (0, react_1.useCallback)(function () {
        setEdit(false);
    }, []);
    ...
    var rowContext = (0, react_1.useMemo)(function () { return ({
        open: openEditMode,
        close: closeEditMode,
    }); }, [openEditMode, closeEditMode]);
    return (React.createElement(RowContext_1.RowContext.Provider, { value: rowContext }, isEdit ? (React.createElement(EditableDatagridRowEditBase_1.EditableDatagridRowEditBase, { mutationOptions: mutationOptions, transform: transform, mutationMode: mutationMode },
        React.createElement(material_1.TableRow, { key: id },
            expand ? (React.createElement(material_1.TableCell, { padding: "none" }, expandable && (React.createElement(react_admin_1.ExpandRowButton, { className: (0, clsx_1.default)(EditableDatagrid_1.DatagridClasses.expandIcon, (_a = {},
                    _a[EditableDatagrid_1.DatagridClasses.expanded] = expanded,
                    _a)), expanded: expanded, onClick: handleToggleExpand, expandContentId: "".concat(id, "-expand") })))) : null,
            hasBulkActions ? (React.createElement(material_1.TableCell, { padding: "checkbox" }, selectable ? (React.createElement(material_1.Checkbox, { color: "primary", checked: selected, disabled: true })) : null)) : null,
            form),
        expandable && expanded && (React.createElement(material_1.TableRow, { key: "".concat(id, "-expand"), id: "".concat(id, "-expand"), className: EditableDatagrid_1.DatagridClasses.expandedPanel },
            React.createElement(material_1.TableCell, { colSpan: nbColumns }, (0, react_1.isValidElement)(expand)
...
exports.DatagridRowClasses = {
    td: "".concat(PREFIX, "-td"),
};
var StyledDatagridRow = (0, material_1.styled)(react_admin_1.DatagridRow)(function () { return ({
    '& td:last-of-type > *': {
        visibility: 'hidden',
    },
