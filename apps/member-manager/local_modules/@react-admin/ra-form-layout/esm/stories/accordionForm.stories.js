...
import { Admin, ArrayInput, BooleanInput, DateInput, Edit, required, Resource, SaveButton, SelectInput, SimpleFormIterator, TextField, TextInput, Toolbar, Labeled, } from 'react-admin';
...
var CustomerEditAutoClose = function () { return (React.createElement(Edit, { component: "div", title: React.createElement(CustomerTitle, null) },
    React.createElement(AccordionForm, { autoClose: true },
        ...
        React.createElement(AccordionFormPanel, { label: "Preferences" },
            ...
            React.createElement(BooleanInput, { source: "dark_theme" }),
            React.createElement(BooleanInput, { source: "accepts_emails_from_partners" }))))); };
var CustomerCustomToolbar = function (props) { return (React.createElement(Toolbar, __assign({}, props),
...
var CustomerEditWithToolbar = function () { return (React.createElement(Edit, { component: "div", title: React.createElement(CustomerTitle, null) },
    React.createElement(AccordionForm, { toolbar: React.createElement(CustomerCustomToolbar, null) },
        React.createElement(AccordionFormPanel, { label: "Identity", defaultExpanded: true },
            React.createElement(Labeled, { label: "id" },
                React.createElement(TextField, { source: "id" })),
            React.createElement(TextInput, { source: "first_name", validate: required() }),
...
export var CustomToolbar = function () {
    var history = createHashHistory();
    useEffect(function () {
        history.replace('/customers/5/edit');
    }, [history]);
