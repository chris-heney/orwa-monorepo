...
var PreviousButton = function (_a) {
    ...
    var _b = (0, useWizardFormContext_1.useWizardFormContext)(), hasPreviousStep = _b.hasPreviousStep, goToPreviousStep = _b.goToPreviousStep;
    ...
    if (hasPreviousStep || alwaysEnable) {
        return (React.createElement(material_1.Button, __assign({ color: "primary", disabled: disabled, type: "button", "aria-label": label, onClick: handleClick }, rest), label));
    }
    return null;
};
