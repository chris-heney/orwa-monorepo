...
exports.EditInDialogButton = void 0;
 ...
 * );
 */
var EditInDialogButton = function (props) {
    ...
    var editDialog = react_1.default.createElement(EditDialog_1.EditDialog, __assign({}, editDialogProps));
    return (react_1.default.createElement(FormDialogButton_1.FormDialogButton, { icon: icon, label: label, dialog: editDialog, inline: inline, ButtonProps: ButtonProps }));
};
exports.EditInDialogButton = EditInDialogButton;
var defaultIcon = react_1.default.createElement(Create_1.default, null);
