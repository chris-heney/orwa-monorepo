...
exports.inputSelectorFormInputs = exports.InputSelectorForm = void 0;
var material_1 = require("@mui/material");
var omit_1 = __importDefault(require("lodash/omit"));
var react_1 = __importStar(require("react"));
var react_admin_1 = require("react-admin");
var react_hook_form_1 = require("react-hook-form");
var wizard_form_1 = require("../wizard-form");
var InputSelector_1 = require("./InputSelector");
/**
 ...
 * ```
 */
var InputSelectorForm = function (props) {
    ...
    return (react_1.default.createElement(wizard_form_1.WizardForm, __assign({ onSubmit: handleSubmit, shouldUnregister: true }, rest),
        react_1.default.createElement(wizard_form_1.WizardFormStep, { label: selectInputsLabel },
            react_1.default.createElement(InputSelector_1.InputSelector, { source: exports.inputSelectorFormInputs, inputs: inputs.map(function (input) { return input.label; }), validate: (0, react_admin_1.required)() })),
        react_1.default.createElement(wizard_form_1.WizardFormStep, { label: selectValuesLabel },
            react_1.default.createElement(SelectedInputs, { inputs: inputs }),
            react_1.default.createElement(RegisterTemporaryInput, null))));
};
exports.InputSelectorForm = InputSelectorForm;
exports.inputSelectorFormInputs = '@@ra-form-layout-input-selector-form-inputs';
var RegisterTemporaryInput = function () {
    var reset = (0, react_hook_form_1.useFormContext)().reset;
    var goToStep = (0, wizard_form_1.useWizardFormContext)().goToStep;
    var _a = (0, react_admin_1.useSaveContext)(), registerMutationMiddleware = _a.registerMutationMiddleware, unregisterMutationMiddleware = _a.unregisterMutationMiddleware;
    var middleware = (0, react_1.useCallback)(function (resource, params, options, next) { return __awaiter(void 0, void 0, void 0, function () {
        var sanitizedParams;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    sanitizedParams = __assign(__assign({}, params), { data: (0, omit_1.default)(params.data, exports.inputSelectorFormInputs) });
...
var SelectedInputs = function (_a) {
    ...
    var selectedInputNames = (0, react_hook_form_1.useWatch)({
        name: exports.inputSelectorFormInputs,
    });
    ...
    return (react_1.default.createElement(StyledBox, { className: SelectedInputsClasses.root },
        react_1.default.createElement(material_1.Stack, { paddingX: 1 }, selectedInputs.map(function (selectedInput) {
            return selectedInput ? (react_1.default.createElement(react_1.default.Fragment, { key: selectedInput.label }, selectedInput.element)) : null;
        }))));
};
...
var StyledBox = (0, material_1.styled)(material_1.Box, {
