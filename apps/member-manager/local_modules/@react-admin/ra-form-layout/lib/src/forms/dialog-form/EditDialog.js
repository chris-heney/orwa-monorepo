...
var EditDialog = function (_a) {
    ...
    return (React.createElement(react_router_dom_1.Routes, null,
        React.createElement(react_router_dom_1.Route, { path: ":id/*", element: React.createElement(EditDialogView, __assign({ resource: resource }, props, { close: close != null ? closeEvent : undefined })) })));
};
...
var EditDialogView = function (props) {
    ...
    return (React.createElement(material_1.Dialog, __assign({ open: open, "aria-labelledby": "edit-dialog-title", onClose: handleClose, "data-testid": "edit-dialog" }, sanitizeRestProps(props)), open ? (React.createElement(EditDialogContentView, __assign({}, props, { onClose: handleClose }))) : null));
};
var EditDialogContentView = function (_a) {
    ...
    var controllerProps = (0, react_admin_1.useEditController)(__assign(__assign({}, props), { mutationOptions: __assign({ onSuccess: function (data, variables, context) {
                if (onSuccess) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(react_admin_1.EditContextProvider, { value: controllerProps },
            React.createElement(FormDialogTitle_1.FormDialogTitle, { id: "edit-dialog-title", title: title, defaultTitle: defaultTitle, onClose: onClose, record: record }),
            record && children)));
};
