...
export var useResourceAppLocation = function () {
    ...
    var resourceLocationInfo = resolveResourceLocationInfo(relativePath, Object.values(resources));
    var record = useGetOne(resourceLocationInfo === null || resourceLocationInfo === void 0 ? void 0 : resourceLocationInfo.resource, {
