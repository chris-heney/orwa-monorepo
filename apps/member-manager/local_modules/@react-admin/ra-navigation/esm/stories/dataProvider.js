...
var baseDataProvider = fakeRestProvider({
    songs: [
        {
            id: 1,
            rank: 1,
...
export var dataProvider = withLifecycleCallbacks(baseDataProvider, [
    {
        resource: 'songs',
...
export var slowDataProvider = new Proxy(dataProvider, {
    get: function (target, name) { return function (resource, params) {
        if (typeof name === 'symbol' || name === 'then') {
            return;
        }
        return new Promise(function (resolve) {
            return setTimeout(function () { return resolve(dataProvider[name](resource, params)); }, 1000);
        });
    }; },
});
