...
var BreadcrumbItem = function (props) {
    var locationMatcher = (0, app_location_1.useAppLocationMatcher)();
    ...
    var currentPath = name === app_location_1.DASHBOARD ? '' : "".concat(path ? "".concat(path, ".") : '').concat(name);
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(Root, __assign({ key: name }, rest), resolvedTo && !exactMatch ? (React.createElement(material_1.Link, { variant: "body2", color: "inherit", component: react_router_dom_1.Link, to: resolvedTo }, translatedLabel)) : (React.createElement(material_1.Typography, { variant: "body2", color: "inherit", component: "span" }, translatedLabel))),
...
var Root = (0, material_1.styled)('li', {
