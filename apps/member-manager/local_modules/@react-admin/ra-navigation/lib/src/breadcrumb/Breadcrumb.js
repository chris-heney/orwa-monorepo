...
var ResourceBreadcrumbItems_1 = require("./ResourceBreadcrumbItems");
/**
...
var Breadcrumb = function (_a) {
    ...
    if (!location.path)
        return null;
    return (React.createElement(Root, __assign({ "aria-label": "Breadcrumb", className: (0, clsx_1.default)(className, (_b = {},
...
exports.Breadcrumb.DashboardItem = DashboardBreadcrumbItem_1.DashboardBreadcrumbItem;
exports.Breadcrumb.ResourceItem = ResourceBreadcrumbItem_1.ResourceBreadcrumbItem;
exports.Breadcrumb.ResourceItems = ResourceBreadcrumbItems_1.ResourceBreadcrumbItems;
var DefaultChildren = React.createElement(exports.Breadcrumb.ResourceItems, null);
