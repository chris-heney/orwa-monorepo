 ...
 */
var useAppLocationState = function () {
    var _a = (0, react_1.useContext)(AppLocationContext_1.LocationContext), location = _a[0], setLocation = _a[1];
    if (typeof setLocation !== 'function') {
        throw new Error("\n            You've tried to access app location outside <AppLocationContext />.\n            Please wrap your code with it first.\n            ");
    }
    var setAppLocation = (0, react_1.useCallback)(function (path, values) {
...
exports.useAppLocationState = useAppLocationState;
