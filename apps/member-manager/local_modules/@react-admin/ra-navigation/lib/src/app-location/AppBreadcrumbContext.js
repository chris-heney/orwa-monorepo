...
exports.AppBreadcrumbContext = (0, react_1.createContext)({ hasDashboard: false });
var AppBreadcrumbContextProvider = function (_a) {
    var children = _a.children, hasDashboard = _a.hasDashboard;
    var context = (0, react_1.useMemo)(function () { return ({ hasDashboard: hasDashboard }); }, [hasDashboard]);
