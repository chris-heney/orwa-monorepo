...
var useDefineAppLocation = function (path, values) {
    var _a = (0, useAppLocationState_1.useAppLocationState)(), _ = _a[0], setLocation = _a[1];
    ...
    }, [JSON.stringify({ path: path, values: values })]); // eslint-disable-line
};
exports.useDefineAppLocation = useDefineAppLocation;
