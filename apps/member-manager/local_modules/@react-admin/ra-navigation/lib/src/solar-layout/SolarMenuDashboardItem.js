...
exports.SolarMenuDashboardItem = void 0;
...
var SolarMenuDashboardItemComponent = function (_a, ref) {
    ...
    // @ts-ignore
    React.createElement(SolarMenuItem_1.SolarMenuItem, __assign({ key: app_location_1.DASHBOARD, name: app_location_1.DASHBOARD, label: app_location_1.DASHBOARD_LABEL, icon: icon == null ? DefaultIcon : icon, to: "/", ref: ref }, props)));
};
var DefaultIcon = React.createElement(Dashboard_1.default, null);
exports.SolarMenuDashboardItem = (0, genericForwardRef_1.genericForwardRef)(SolarMenuDashboardItemComponent);
