...
exports.AppBarClasses = exports.SolarAppBar = void 0;
var React = __importStar(require("react"));
var react_admin_1 = require("react-admin");
var material_1 = require("@mui/material");
var usePrimarySidebarState_1 = require("./usePrimarySidebarState");
var SolarSidebarToggleButton_1 = require("./SolarSidebarToggleButton");
/**
 ...
 * );
 */
var SolarAppBar = function (_a) {
    var alwaysOn = _a.alwaysOn, className = _a.className, _b = _a.color, color = _b === void 0 ? 'secondary' : _b, _c = _a.container, Container = _c === void 0 ? alwaysOn ? 'div' : react_admin_1.HideOnScroll : _c, children = _a.children, rest = __rest(_a, ["alwaysOn", "className", "color", "container", "children"]);
    var isSidebarOpen = (0, usePrimarySidebarState_1.usePrimarySidebarState)()[0];
    var isXSmall = (0, material_1.useMediaQuery)(function (theme) {
        return theme.breakpoints.down('sm');
    });
    return (React.createElement(Container, { className: className },
        React.createElement(StyledAppBar, __assign({ className: exports.AppBarClasses.appBar, color: color, isSidebarOpen: isSidebarOpen }, rest),
            React.createElement(material_1.Toolbar, { disableGutters: true, variant: isXSmall ? 'regular' : 'dense', className: exports.AppBarClasses.toolbar },
                React.createElement(SolarSidebarToggleButton_1.SolarSidebarToggleButton, { className: exports.AppBarClasses.menuButton }),
                React.createElement(react_admin_1.TitlePortal, null),
                React.createElement(material_1.Stack, { direction: "row", marginLeft: "auto", alignItems: "center" }, children || React.createElement(react_admin_1.LoadingIndicator, null))))));
};
exports.SolarAppBar = SolarAppBar;
...
var AppBar = React.forwardRef(function (_a, ref) {
    ...
    return React.createElement(material_1.AppBar, __assign({ ref: ref }, props));
});
...
var StyledAppBar = (0, material_1.styled)(AppBar, {
    name: PREFIX,
