...
/**
 * Prefer OS Arial (Windows `C:/Windows/Fonts/arial.ttf` and WSL `/mnt/c/...`)
 * at runtime. Browser print cannot read those files, so fall back to Helvetica
 * — the PDF core metric cousin of Arial — without shipping font files.
 */
