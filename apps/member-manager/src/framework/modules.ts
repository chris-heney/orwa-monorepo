 ...
 */
export const MODULES: ModuleManifest[] = [dashboardModule, mediaLibraryModule, emailsModule, termsModule, assetsModule, rbacModule, membershipsModule, grantsModule, trainingModule, corporateSponsorsModule, conferenceModule, contactsModule, settingsModule, scholarshipsModule];
