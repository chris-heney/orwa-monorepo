...
export const TRAINING_DASHBOARD_INFO =
  'Pipeline overview: review queue, DEQ queue, upcoming events, and recent activity.'

/**
 * Body of the `training.dashboard` page (the heading bar is the framework
 * TitleBar): pipeline counts, work queues grouped by "what needs doing", the
 * activity feed, and the upcoming-events calendar.
 */
