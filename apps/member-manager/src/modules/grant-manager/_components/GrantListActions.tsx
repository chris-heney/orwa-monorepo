...
import { GrantSearchFilter } from './GrantFilterSearch'
...
const GrantListActions = ({
  ...
  return (
    ...
    <TopToolbar sx={{ flexGrow: 1, px: 2 }}>
      {filterLiveSearch && <GrantSearchFilter label={filterLiveSearchLabel} />}
      {total > 0   && (
...
export default GrantListActions
