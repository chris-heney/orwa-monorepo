        ...
        <Card sx={{ p: 2, my: 2, mx: 1 }}>
          ...
          <Grid item xs={12} sm={12} md={12} lg={12}>
            ...
            <TextInput
              ...
              label="Borchure Link"
              helperText="Displays a link on the conference hub to the booklet"
              fullWidth
              multiline
            />
          </Grid>
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} md={6}>
              <NumberInput
                ...
                label="Available Golf Contestants"
                fullWidth
                helperText="Golf tournament inventory — only Golfer tickets count against this limit. Fishing tickets are not limited by it."
              />
            </Grid>
          </Grid>
        </Card>
