...
import { useDomainProvider } from '../context/DomainProvider';
import { DomainMobileSavedViews } from './DomainMobileSavedViews';

interface DomainMobileToolbarProps {
    onFilterClick: () => void;
}

export const DomainMobileToolbar: React.FC<DomainMobileToolbarProps> = ({ onFilterClick }) => {
