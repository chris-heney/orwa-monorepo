...
import { useSubscriberProvider } from '../context/SubscriberProvider';

interface SubscriberMobileToolbarProps {
    onFilterClick: () => void;
}

export const SubscriberMobileToolbar: React.FC<SubscriberMobileToolbarProps> = ({ onFilterClick }) => {
