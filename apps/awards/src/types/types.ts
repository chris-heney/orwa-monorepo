...
export interface IAwardNominationPayload {
  ...
  award_type: 'Water/Wastewater System of the Year' | 'Excellence in Operations' | 'Excellence in Management' | 'Excellence in Office Operations';
  award_year?: number;
  ...
  // Status
  nomination_status?: 'Draft' | 'Submitted' | 'Under Review' | 'Approved' | 'Denied';
