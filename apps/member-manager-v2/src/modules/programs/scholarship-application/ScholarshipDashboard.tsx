...
import {
    ...
    TabValue,
} from './ScholarshipContextProvider';
                    ...
                    <TabContext value={selectedTab}>
                        ...
                        >
                            <ScholarshipApplicationList
                                filter={getFilterForTab('applications')}
                            />
                        </TabPanel>
                        ...
                        >
                            <ScholarshipApplicationList
                                filter={getFilterForTab('approved')}
                            />
                        </TabPanel>
