  ...
  return (
    <SimpleForm validate={AssetValidate} sx={{p: 0}}>
      ...
      <Grid container sx={{ alignItems: 'stretch' }} justifyItems={'stretch'} alignSelf={'stretch'}> 
        <Grid item xs={12} md={6} lg={6} sm={12} sx={{ alignItems: 'stretch' }} justifyItems={'stretch'} alignSelf={'stretch'}>
        ...
        <Grid item xs={12} sx={{ alignItems: 'stretch' }} justifyItems={'stretch'} alignSelf={'stretch'}>
          <Card sx={{ p: 2, my: 2, mx: 1 }}>
